    ...
    return (
      <div className="space-y-10">
        <PageHeader
          eyebrow="Dashboard"
          title="Projects"
          description="Workspace projects for Screener Studio and other tools."
        />
        <GlassCard className="flex items-start gap-4 border-amber-300/40 bg-amber-50/60 p-6 text-amber-950 ring-1 ring-inset ring-amber-200/40 dark:border-amber-400/30 dark:bg-amber-500/10 dark:text-amber-100 dark:ring-amber-400/20">
          ...
          <div className="space-y-2">
            <p className="text-sm font-semibold">Could not load projects</p>
  ...
  return (
    <div className="space-y-10">
      <PageHeader
        eyebrow="Dashboard"
        title="Projects"
        description="Open a project to manage screeners and linked tool outputs."
        actions={
          <Button asChild variant="secondary">
            <Link href="/projects">Workspace projects hub</Link>
          </Button>
        }
      />
      ...
      {projects.length === 0 ? (
        <EmptyState
          ...
          description="Create a project in the workspace hub first, then return here to add screeners."
          action={
            <Button asChild>
